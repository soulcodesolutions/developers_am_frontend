...
export default function Hero({ data, data2, language }) {
    ...
    return (
        <>
            ...
            <div className="bg-cover bg-no-repeat sm:bg-cover sm:bg-fixed    bg-[url(/images/bg13.png)] bg-top  sm:bg-top mx-auto h-[1400px] sm:h-[1200px] xl:h-[100vh] xl:min-h-[850px]  xl:max-h-[900px] _xl:h-[calc(100vh-0px)]">
