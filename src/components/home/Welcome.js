...
import WelcomeImage from "../../images/home/welcome3.jpg";
        ...
        <div id="aboutus" className="pt-[50px] px-[30px] sm:px-[20px]  xl:pt-[20px] _py-[30px] relative  ">
            {/* <div className="xl:absolute bottom-[30px] w-full"> */}
                <div className="  max-w-[1200px] relative mx-auto bg-white/60 backdrop-blur-lg p-[10px] md:p-[30px]    sm:drop-shadow-2xl shadow rounded-[10px]">
                    ...
                    <div className="text-[16px] sm:text-[20px] xl:text-[20px] text-center sm:text-center xl:text-center font-bold text-red-800  ">
                        <SlideLeft>
                    ...
                    <div className=" content pt-[50px] sm:pt-[10px]">
                        <div className="flex flex-wrap sm:flex-nowrap xl:flex-nowrap sm:h-fit  justify-center ">
                            ...
                            <div className="w-full text-[16px] sm:text-[14px] xl:text-[16px]  px-[20px]  pt-[50px] sm:pt-[10px] xl:pt-[15px]  xl:pl-[50px]     xl:max-w-[810px] overflow-hidden _text-center sm:text-left  ">
                                <JustAppear>
