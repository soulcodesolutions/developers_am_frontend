...
export default function Welcome({ data }) {
    // console.log(data)
    return (
        <div id="aboutus" className="pt-[50px]   xl:pt-[0px] _py-[30px] relative  ">
            {/* <div className="xl:absolute bottom-[30px] w-full"> */}
                <div className="  max-w-[1050px] relative mx-auto bg-white/60 backdrop-blur-lg p-[10px] md:p-[30px]    sm:drop-shadow-2xl shadow rounded-[10px]">
