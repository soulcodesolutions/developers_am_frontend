...
export default function Welcome({ data }) {
    // console.log(data)
    return (
        <div id="aboutus" className="pt-[50px]   xl:pt-[0px] py-[30px] relative">
            <div className="xl:absolute bottom-0 w-full">
                <div className="  max-w-[1050px] relative mx-auto bg-white/60 backdrop-blur-lg p-[10px] md:p-[30px]  max-w-[1200px] sm:drop-shadow-2xl shadow rounded-[20px]">
                    ...
                    <div className="text-[24px] sm:text-[28px] xl:text-[28px] text-center sm:text-left xl:text-center font-bold text-red-800 ">
                        <SlideLeft>
