...
export default function Welcome({ data }) {
    // console.log(data)
    return (
        <div id="aboutus" className="pt-[50px] sm:pt-[0px] xl:pt-[100px] py-[50px] relative">
            <div className="xl:absolute bottom-0 w-full">
            <div className="relative mx-auto bg-white/80 backdrop-blur-3xl p-[50px] max-w-[1200px] sm:drop-shadow-2xl rounded-[20px]">
                ...
                <div className="content pt-[50px] sm:pt-[50px]">
                    <div className="flex flex-wrap justify-between">
                        <div className="w-full xl:w-1/2 flex flex-col _items-center justify-center  ">
                            <SlideLeft>
                                <img src={WelcomeImage} className="_w-full _sm:max-w-[500px] rounded-xl max-h-[300px] mx-auto sm:ml-0" alt="" />
                            </SlideLeft>
                        </div>
