    ...
    return (
        <div id="aboutus" className="pt-[50px]   xl:pt-[0px] _py-[30px] relative  ">
            {/* <div className="xl:absolute bottom-[30px] w-full"> */}
                <div className="  max-w-[1360px] relative mx-auto bg-white/60 backdrop-blur-lg p-[10px] md:p-[30px]    sm:drop-shadow-2xl shadow rounded-[10px]">
                    ...
                    <div className=" content pt-[50px] sm:pt-[10px]">
                        <div className="flex flex-wrap xl:flex-nowrap sm:h-fit  justify-center ">
                            <div className="  w-full xl:w-fit   flex flex-col xl:items-center justify-center   ">
                                ...
                                <div className="  ">
                                    <img src={WelcomeImage} className=" h-full w-content max-h-[280px] rounded-xl mx-auto sm:ml-0  " alt="" />
                                </div>

                            </div>
                            <div className="w-full   pt-[50px] xl:pt-[15px] xl:pl-[50px] xl:max-w-[980px] overflow-hidden _text-center sm:text-left  ">
                                <JustAppear>
