...
export default function Welcome({ data }) {
    // console.log(data)
    return (
        <div id="aboutus" className="pt-[50px]   xl:pt-[40px] py-[50px] relative">
            <div className="xl:absolute bottom-0 w-full">
                <div className="  max-w-[1050px] relative mx-auto bg-white/80 backdrop-blur-3xl p-[10px] md:p-[50px] max-w-[1200px] sm:drop-shadow-2xl shadow rounded-[20px]">
                    ...
                    <div className="text-[24px] sm:text-[28px] xl:text-[30px] text-center sm:text-left xl:text-center font-bold text-red-800 ">
                        <SlideLeft>
                    ...
                    <div className=" content pt-[50px] sm:pt-[10px]">
                        <div className="flex flex-wrap xl:flex-nowrap sm:h-fit  justify-center ">
                            <div className="  w-full xl:w-fit   flex flex-col xl:items-center justify-center   ">
                                ...
                                <div className="  ">
                                    <img src={WelcomeImage} className=" h-full w-content max-h-[320px] rounded-xl mx-auto sm:ml-0  " alt="" />
                                </div>

                            </div>
                            <div className="w-full   pt-[50px] xl:pt-[15px] xl:pl-[50px] xl:max-w-[600px] overflow-hidden _text-center sm:text-left  ">
                                <JustAppear>
